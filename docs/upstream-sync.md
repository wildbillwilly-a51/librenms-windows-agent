# Source Transition History

## Current Model

As of 2026-07-14, this repository is the canonical universal development and
distribution source. Agent, collector, MSI, tests, and LibreNMS overlay changes
are made here using the public identities:
...
Native builders now produce the MSI and overlay directly from `src/`,
`installer/`, and `librenms-overlay/`. The former text-conversion promotion
script has been retired.

Private projects may consume public builds for environment-specific validation,
but they are not upstream product sources. Do not copy private hostnames, IPs,
credentials, device IDs, deployment scripts, branding, or exports into this
repository.

## Historical Promotion Record

The records below document releases created before the source transition. They
are retained for artifact provenance and checksum history; their promotion
method is no longer the active workflow.
...
- Public package: `artifacts/librenms-windows-agent-overlay-0.6.10.tar.gz`
- Public Windows MSI: `artifacts/librenms-windows-agent-0.6.10.msi`
- Upstream development commit: `fca2b3f`
- Overlay SHA256:
  `4bd45ecbc2b8ed6c84746add38483846de9ade85457260ad71804e9ee8c34f51`
- Windows MSI SHA256:
  `eb01960ba5a7e37543538bb460604e3de799744e887a5e020f38c0dbf0ed8f70`
- Compatibility: requires Windows agent output using `windows_agent` and
  `windows_agent_*` section names.
- Promotion method: `scripts/promote-from-dev-overlay.ps1` built the
  development overlay package and public MSI into temporary directories,
...
- Public package: `artifacts/librenms-windows-agent-overlay-0.6.11.tar.gz`
- Public Windows MSI: `artifacts/librenms-windows-agent-0.6.11.msi`
- Upstream development commit: `751f167`
- Overlay SHA256:
  `d6d5045ec8c4b717261a11f63abd821a4fd9b54741e2f3bbd6265520c297d50f`
- Windows MSI SHA256:
  `9c70201e5ba89cc84c7c827f8ae44de67c18d783c6d447334df6855cf53192f8`
- Compatibility: requires Windows agent output using `windows_agent` and
  `windows_agent_*` section names.
- Promotion method: `scripts/promote-from-dev-overlay.ps1` built the
  development overlay package and public MSI into temporary directories,
