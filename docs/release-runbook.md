...
tar -xzf .\artifacts\librenms-windows-agent-overlay-0.6.11.tar.gz -C $tmp
...
curl.exe -fsSI https://raw.githubusercontent.com/wildbillwilly-a51/librenms-windows-agent-installer/main/artifacts/librenms-windows-agent-overlay-0.6.11.tar.gz
curl.exe -fsSI https://raw.githubusercontent.com/wildbillwilly-a51/librenms-windows-agent-installer/main/artifacts/librenms-windows-agent-0.6.11.msi
```
