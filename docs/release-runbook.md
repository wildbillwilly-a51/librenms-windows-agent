...
tar -tzf .\artifacts\librenms-windows-agent-overlay-0.6.2.tar.gz
Get-FileHash -Algorithm SHA256 .\artifacts\librenms-windows-agent-overlay-0.6.2.tar.gz
Get-FileHash -Algorithm SHA256 .\artifacts\librenms-windows-agent-0.6.2.msi
git diff --check
```
...
tar -xzf .\artifacts\librenms-windows-agent-overlay-0.6.2.tar.gz -C $tmp
...
curl.exe -fsSI https://raw.githubusercontent.com/wildbillwilly-a51/librenms-windows-agent-installer/main/artifacts/librenms-windows-agent-overlay-0.6.2.tar.gz
curl.exe -fsSI https://raw.githubusercontent.com/wildbillwilly-a51/librenms-windows-agent-installer/main/artifacts/librenms-windows-agent-0.6.2.msi
```
